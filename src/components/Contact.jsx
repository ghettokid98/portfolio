...
import { slideUpVariants,slideFromLeftVariants,slideFromRightVariants } from "./Animation";
        ...
        <section id="contact" className="mt-6">
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                <motion.div className="mb-12 lg:mb-0 lg:flex lg:flex-col" initial="hidden" whileInView="visible" variants={slideUpVariants}>
                    ...
                    <motion.p className="text-zinc-400 mt-3 mb-8 max-w-[450px] lg:max-w-[30ch]" initial="hidden" whileInView="visible" variants={slideUpVariants}>
                        Contact me to discuss your project requirements and explore
                        opportunities for collaboration on something exceptional.
                    </motion.p>

                    <motion.div className="flex items-center gap-2 mt-auto" initial="hidden" whileInView="visible" variants={slideUpVariants} >
                ...
                <motion.form action="https://getform.io/f/bjjjkzqb" method="post" className="xl:pl-10 2xl:pl-20" initial="hidden" whileInView="visible" variants={slideUpVariants}>
                    <div className=" md:grid md:items-center md:grid-cols-2 md:gap-2">
                        ...
                        <div className="mb-4">
                            ...
                            <input
                                ...
                                name="email"
                                className="text-field"
                                placeholder="nyamberoyd17@gmail.com"
                                autoComplete="name"
                                required
                            />
                        </div>
                    ...
                    <div className="mb-4">
                        ...
                        <motion.button type="submit" className="btn btn-primary [&]:max-w-full w-full justify-center" initial="hidden" whileInView="visible" variants={slideUpVariants}> 
                            Submit
                        </motion.button>
